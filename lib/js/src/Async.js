...
var I = /* module */[/* compare */compare];

var IntMap = $$Map.Make(I);

function both(a, b, param) {
  var fe = param[1];
  var fs = param[0];
  var theA = [/* None */0];
  var theB = [/* None */0];
  var theErr = [/* None */0];
  var fe$1 = function (err) {
    if (Js_option.isNone(theErr[0])) {
      theErr[0] = /* Some */[err];
      return Curry._1(fe, err);
    } else {
      return 0;
    }
  };
  ...
  run(/* Some */[fe$1], (function (x) {
          theA[0] = /* Some */[x];
          return checkComplete(/* () */0);
        }), once(a));
  return run(/* Some */[fe$1], (function (x) {
                theB[0] = /* Some */[x];
                return checkComplete(/* () */0);
              }), once(b));
}
